...
COMMAND_DC_VERSION = docker compose version
...
## Running all services by docker-compose -d
.PHONY: devops/up
...
docker-compose-version = $(call quiet-command,${COMMAND_DC_VERSION} ${1} | cat,"${YELLOW}[COMPOSE UP SERVICES] ${GREEN}${1}${RESET}")